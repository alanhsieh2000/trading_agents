...
4. For each crew Python file, follow the `ContentCrew` pattern:
   ...
   Use `Process.sequential` for fixed task sequences. The iterative helper functions can call a crew or agent tasks repeatedly.
